...
function OverviewPagamentos({ onSelectDJ, refreshKey }) {
...
export function ContasDJs() {
  ...
  const handleOverviewSelectDJ = (id) => {
    setDjSel(id)
    setPremioOverride(null)
    setTimeout(() => djDetailRef.current?.scrollIntoView({ behavior: 'smooth', block: 'start' }), 100)
  }
  ...
  return (
    <div className="p-6 flex flex-col gap-6 max-w-5xl mx-auto">
      ...
      {/* ── Overview pagamentos ── */}
      <OverviewPagamentos onSelectDJ={handleOverviewSelectDJ} refreshKey={refreshPag} />

      {/* ── Selector DJ ── */}
      <div ref={djDetailRef} className="flex items-center gap-3 flex-wrap">
